...
const BlindGenerator = () => {
  ...
  const downloadCutList = () => {
    ...
    // Calculate additional vertical boards needed (height / 610)
    const additionalVerticals = Math.floor(height / 610);
    
    const tableData = [
      [verticalWidth, verticalHeight, slatDepth, 2 + additionalVerticals],
                  ...
                  <table className="w-full text-sm font-mono">
                    ...
                    <tbody>
                      <tr className="border-b border-border">
                        ...
                        <td className="px-4 py-2 text-foreground">{2 + Math.floor(height / 610)}</td>
                      </tr>
                      <tr>
